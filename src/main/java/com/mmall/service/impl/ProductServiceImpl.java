...
public class ProductServiceImpl implements IProductService{
    ...
    public ServerResponse saveOrUpdateProduct(Product product){
        ...
        return ServerResponse.createByErrorMessage("新增或更新产品信息错误！");
    }
    ...
    public ServerResponse<ProductDetailVo> manageProductDetail(Integer productId){
        ...
        if (product == null){
            return ServerResponse.createByErrorMessage("产品下架或者已被删除");
        }
    ...
    public ServerResponse<PageInfo> getProductByKeywordCateGory(String keyword,Integer categoryId,int pageNum,int pageSize,String orderBy){
        ...
        List<Product> productList = productMapper.selectByNamesAndCategoryIds(StringUtils.isNotBlank(keyword)?null:keyword,
